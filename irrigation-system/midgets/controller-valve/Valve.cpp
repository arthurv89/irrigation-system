...
void handle(IRunner* iRunner) {
  ...
  StaticJsonDocument<200> response = get_response();
...
StaticJsonDocument<200> get_response() {
  ...
  StaticJsonDocument<200> response = _deserializeJson(valveInstructionsJson)["response"];
...
void execute_instructions(StaticJsonDocument<200> response){
